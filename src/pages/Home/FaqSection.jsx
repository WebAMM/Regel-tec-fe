...
const FaqSection = ({ openReGelTecFaq, openHydrafil }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `<a href='https://regeltec.com/hydrafil/' target="_blank" class="text-[#00B4F1]">HYDRAFIL</a> is an injectable spinal implant for minimally invasive treatment of chronic low back pain from degenerative disc disease. It is a proprietary hydrated polymer gel (hydrogel) technology that, when heated, becomes a liquid that can be injected through a needle directly into the nucleus of a degenerated lumbar disc in your spine. Once it enters the body, the gel cools to form an integrated solid implant within the disc, forming a soft, space-filling implant that mimics the same properties of the natural disc and works to preserve spinal motion.\n\nThe HYDRAFIL implant is designed to supplement and reinforce the interior of the degenerated disc (disc augmentation) without requiring the destruction or removal of any existing disc material.\n\nHYDRAFIL is an investigational device. It is limited by federal (or United States) law to investigational use.`,
    },
    {
