...
const FaqSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `<a href='https://regeltec.com/hydrafil/'  class="text-[#00B4F1]">HYDRAFIL</a> is an injectable spinal implant for minimally invasive treatment of chronic low back pain from degenerative disc disease. It is a proprietary hydrated polymer gel (hydrogel) technology that, when heated, becomes a liquid that can be injected through a needle directly into the nucleus of a degenerated lumbar disc in your spine. Once it enters the body, the gel cools to form an integrated solid implant within the disc, forming a soft, space-filling implant that mimics the same properties of the natural disc and works to preserve spinal motion.\n\nThe HYDRAFIL implant is designed to supplement and reinforce the interior of the degenerated disc (disc augmentation) without requiring the destruction or removal of any existing disc material.\n\nHYDRAFIL is an investigational device. It is limited by federal (or United States) law to investigational use.`
    },
    {
      question: "What is ReGelTec?",
      answer: `<a href='https://regeltec.com/' class="text-[#00B4F1]">ReGelTec, Inc.</a> is a clinical stage medical device company developing the next generation of minimally invasive spinal implants for chronic lower back pain due to degenerative disc disease. ReGelTec is the sponsor of the HYDRAFIL-D research study.`
    },
    {
      question: "How do I know if I qualify?",
      answer: `The first step is to complete the pre-screener on this website to see if you might be eligible. If you pass the pre-screener, you may qualify for the study. If you pass the pre-screener and an active study center is available in your local area, your information will be provided to the research staff at the local study center. Someone from the study center may contact you to tell you more about the study, ask you more questions, answer your questions, and possibly schedule an office visit. You can only know definitively if you qualify for the study through completing the screening process with the local study center. Passing the pre-screener does not guarantee that you will qualify for the study.`
    },
    {
