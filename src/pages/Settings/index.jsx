...
const Settings = () => {
  ...
  const [referralEmailNotification, setReferralEmailNotification] =
    useState(true);
  ...
  return (
    <div className=" p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="flex items-center justify-between py-4 border-b border-gray-100">
        <div>
          <h3 className="text-lg font-medium text-gray-900">
            Enable Auto PDF Email Delivery
          </h3>
          <p className="text-sm text-gray-500">
            Automatically send user & pre-screener data in PDF format
          </p>
        </div>
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div
            className={`w-12 h-6 rounded-full peer ${
              autoPdfEnabled ? "bg-green-500" : "bg-gray-200"
            } peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all`}
          ></div>
        </label>
      </div>
      ...
      <div className="flex items-center justify-between py-4 border-b border-gray-100">
        <div>
          <h3 className="text-lg font-medium text-gray-900">
            New Pre-Screener Submission
          </h3>
          <p className="text-sm text-gray-500">
            Get notified when a new pre-screener form is submitted
          </p>
        </div>
        <label className="relative inline-flex items-center cursor-pointer">
          <input
            ...
            onChange={() =>
              setNewScreenerNotification(!newScreenerNotification)
            }
          />
          <div
            className={`w-12 h-6 rounded-full peer ${
              newScreenerNotification ? "bg-green-500" : "bg-gray-200"
            } peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all`}
          ></div>
        </label>
      </div>
      ...
      <div className="flex items-center justify-between py-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Get confirmation when referral emails are sent
          </p>
        </div>
        <label className="relative inline-flex items-center cursor-pointer">
          <input
            ...
            onChange={() =>
              setReferralEmailNotification(!referralEmailNotification)
            }
          />
          <div
            className={`w-12 h-6 rounded-full peer ${
              referralEmailNotification ? "bg-green-500" : "bg-gray-200"
            } peer-checked:after:translate-x-6 after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all`}
          ></div>
        </label>
      </div>
