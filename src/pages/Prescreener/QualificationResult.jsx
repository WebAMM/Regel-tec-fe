...
const QualificationResult = ({
    ...
    const qualifiedContent = {
        ...
        description: `Based on your responses to this initial questionnaire, it appears you may qualify for the ${studyName} research <br/> study. The final decision will be made by the local study doctor. Please click Next to enter your contact <br/> information so someone from the local study center can contact you.`,
        image: circleCheck,
        buttonText: "Next",
    ...
    const studyCenterNotFoundContent = {
     ...
     description: `Thank you for your interest in the HYDRAFIL-D research study. Based on your responses to this initial questionnaire, it appears you may<br/> qualify for this study; however, no local study center is available in your area at this time.<br/>Please check back to this study website regularly for updates on new study locations that may be opening in the future. You may be able to <br/> participate if a new local study center location opens near you.<br/><div style="margin-top: 0.5rem;">If you still wish to leave your contact information, please click Next to enter your contact information. You will not be contacted by a local <br/> study center at this time. However, should a study center open in your area in the future, we may share your contact information with their research staff.`,
        image: circleCheck,
        buttonText: "Next",
