...
const AddPreScreenerQuestions = () => {
  ...
  const [addSectionsQuestions, { isLoading }] =
    useAddSectionsQuestionsMutation();
  const questionTypes = ["TextBox", "NumericBox", "DropDown", "TrueFalse"];
  const boolType = [
    { label: "Yes", value: "Yes" },
    { label: "No", value: "No" },
  ];

  const dropdownType = [{ label: "", value: "" }];
  const textType = {
                        ...
                        <div className="mb-4">
                          <div className="flex py-3 justify-between items-center">
                            <label
                              ...
                              htmlFor={`payload.${sectionIndex}.title`}
                            >
                              ...
                              {section.questions.map(
                                (question, questionIndex) => (
                                  ...
                                  >
                                    ...
                                    <FieldArray
                                      name={`payload.${sectionIndex}.questions.${questionIndex}.meta.options`}
                                    >
                                      {({
                                        remove: removeOption,
                                        push: pushOption,
                                                    ...
                                                    <Field
                                                      ...
                                                      onChange={(e) => {
                                                        ...
                                                        const newValue =
                                                          e.target.value;
                                                        setFieldValue(
                                                          `payload.${sectionIndex}.questions.${questionIndex}.meta.options[${index}].label`,
                                                          newValue
                                                        );
                                                        setFieldValue(
                                                          `payload.${sectionIndex}.questions.${questionIndex}.meta.options[${index}].value`,
                                                          newValue
                                                        );
                                                      }}
                                                    />
                                    ...
                                    {question?.type === "TrueFalse" && (
                                      <div>
                                        ...
                                        <Field
                                          as="select"
                                          name={`payload.${sectionIndex}.questions.${questionIndex}.meta.correct`}
                                          className="px-4 py-2 border rounded"
                                        >
                                          <option value="">
                                            Select an option
                    ...
                    <button
                      ...
                      onClick={() => {
                        const lastSectionOrder =
                          values.payload[values.payload.length - 1]?.order || 0;
                        pushSection({
                          title: "",
