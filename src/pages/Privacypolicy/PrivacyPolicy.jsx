    ...
    <div className="max-w-[77%] mx-auto p-6 bg-white pt-[100px]">
      ...
      <div className="space-y-8 text-[#39394A] font-relay">
        ...
        <section className="leading-7">
          ...
          <p className="">
            ReGelTec, Inc. ("we," "our," or "us") is committed to safeguarding
            the privacy of individuals ("you" or "participants") who visit our
            website and provide personal information to participate in our
            clinical trial for an injectable spinal implant targeting back pain
            caused by degenerative disc disease. This Privacy Policy outlines
        ...
        <section className="leading-7">
          ...
          <p className="mb-4">
            ...
            information you provide may be used and disclosed in accordance with
            this Privacy Policy, your express written consent, to comply with a
            valid court order, or applicable laws. The information we collect
            from you includes eligibility information (on our pre-screener) and
          ...
          <ul className="list-disc pl-6 space-y-2 mb-4 text-sm">
            ...
            <li>
              Confirmation of duration of chronic low back pain of at least 6
              months (Yes or No)
            </li>
            <li>
              Confirmation of any history of lumbar spine surgery (Yes or No)
            </li>
            <li>Sex, height, and weight (to calculate Body Mass Index)</li>
            <li>
              Confirmation of any cigarette, nicotine, or tobacco use (Yes or
              No)
            </li>
            <li>
              Confirmation of having insulin-dependent diabetes mellitus (Type 1
              diabetes) (Yes or No)
            </li>
            <li>
              Confirmation of having had an MRI in the last 6 months (Yes or No)
            </li>
          </ul>
          ...
          <p className="my-4">
            The contact information we collect from you contains personally
            identifiable information, including your name. Contact information
            will only be collected from you if you pre-qualify after completing
            our pre-screener. Your eligibility information and contact
            information will be linked and your identity will not be coded.
            Otherwise, if you do not pre-qualify, any eligibility information we
            collect from you will not be linked to any personally identifiable
            information.
          </p>
        </section>
        ...
        <section className="leading-7">
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm">
            <li>
              ...
              clinical trial and connect you with an appropriate local study
              center, if applicable{" "}
            </li>
            <li>
              Communicate with you regarding trial details, updates, and related
              opportunities{" "}
            </li>
            <li>Maintain records as required by regulatory guidelines </li>
            <li>
              Evaluate the reason(s) you were not eligible for the study for
              purposes of market research and to communicate with the FDA
          ...
          <p className="my-4">
            ...
            information and cannot be used to identify you, may be analyzed and
            shared in the individual or in the aggregate for our legitimate
            business purposes.
          </p>
        </section>
        ...
        <section className="leading-7">
          ...
          <p className="mb-4">
            ...
            collect from you will only be shared in accordance with this Privacy
            Policy and will not be shared with anyone outside the research
            unless required by law or a valid court order. We may share your
            information with:
          </p>

          <ul className="list-disc pl-6 space-y-2 text-sm">
            <li>
              Clinical Study Sites, Clinical Research Organizations (CROs), and
              Partners: Trusted entities assisting in conducting the clinical
              trial, bound by confidentiality agreements.
            </li>
            <li>
              Regulatory Authorities: As required to comply with applicable laws
              and regulations.{" "}
            </li>
          </ul>
        </section>
        ...
        <section className="leading-7">
          ...
          <p className="mb-3">
            ...
            responsible for the content or privacy practices of such sites. We
            encourage users to be aware when they leave our site and to read the
        ...
        <section className="leading-7">
          ...
          <p className="mb-4">
            ...
            usage. Cookies are small data files stored on your device that help
            us understand how you interact with our site. You can manage your
        ...
        <section className="leading-7">
          ...
          <ul className="list-disc pl-6 space-y-2 text-sm">
            <li>
              Right to Know: You may request information about the categories
